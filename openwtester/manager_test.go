...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO GXT", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W6N8MPsEBSi95HRnCnzxFwknrwzqjYMNuz")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "W6N8MPsEBSi95HRnCnzxFwknrwzqjYMNuz"
	account := &openwallet.AssetsAccount{Alias: "mainnetGXT", WalletID: walletID, Required: 1, Symbol: "GXT", IsTrust: true}
